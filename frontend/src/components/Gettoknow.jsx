...
export default function GetToKnow() {
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 sm:p-12 my-8 text-gray-700 leading-relaxed">
      <h2 className="text-3xl sm:text-4xl font-bold text-center mb-6 text-gray-900">✨ Get to Know Me</h2>
      <p className="text-center text-sm text-gray-500 mb-8">
        By <strong>Sonu Kathat</strong>, Founder of <strong>H&amp;S Jewellery</strong>
      </p>
      ...
      <h3 className="mt-8 text-xl font-semibold text-indigo-600">💎 Our Philosophy</h3>
      <p className="mt-2">
      ...
      <h3 className="mt-8 text-xl font-semibold text-indigo-600">🛠️ Craftsmanship with Soul</h3>
      <p className="mt-2">
      ...
      <h3 className="mt-8 text-xl font-semibold text-indigo-600">🌟 Our Mission</h3>
      <p className="mt-2">
      ...
      <h3 className="mt-8 text-xl font-semibold text-indigo-600">🤍 A Note from Me</h3>
      <p className="mt-2">
