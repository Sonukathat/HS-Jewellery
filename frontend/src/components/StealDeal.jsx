    ...
    const fetchStealImg = async () => {
      try {
        ...
        const selected = categories.flatMap((cat) =>
          cat.images.details.slice(0, 2).map((item, index) => ({
            ...item,
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="mr-2 bg-gradient-to-r from-[#f4d7c2] to-[#FFE2F0] text-black font-serif text-xs px-2 py-1 rounded cursor-pointer hover:from-[#ffd1a8] hover:to-[#ffc7de] transition-all duration-300"
                >
                  Buy Now
                </button>
              </div>
