    ...
    return (
        <div className="py-4">
            ...
            <div className="flex flex-row-reverse">
                <p className="text-sm mr-6 mt-4 lg:mr-36 xl:mr-48">Sort by:Alphabetically, A-Z368 products</p>
            </div>
            <div className="mt-4 grid grid-cols-1 gap-8 px-4 lg:px-28 xl:px-48 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {info.map((item, index) => (
                    <div key={index} className='border border-gray-200 rounded-md hover:border-gray-500 transition-all duration-300 ease-in-out overflow-hidden'>
                        <img src={images} alt="jewelery" className="h-80 w-full transition-transform duration-500 ease-in-out transform hover:scale-101" />
